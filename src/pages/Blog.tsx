...
export function Blog() {
    return (
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 space-y-6">
            <h1 className="font-serif text-3xl font-bold text-[#1B4D3E]">Blog Lingwistiku</h1>
            ...
            <div className="space-y-4">
              ...
              hover:border-[#1B4D3E] hover:shadow-md transition-all">
                            <div className="flex gap-2 mb-2">
                                {post.tags?.map(t => <Badge key={t} variant="tag">{t}</Badge>)}
                            </div>
                            <h2 className="font-serif text-xl font-semibold text-[#1B4D3E] group-hover:text-[#1034A6] transition-colors">
                                {post.title}
                            </h2>
    ...
    return (
        <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
            ...
            <div className="bg-white border border-[#d8cfc0] rounded-xl p-6 sm:p-8">
                ...
                <h1 className="font-serif text-3xl font-bold text-[#1B4D3E] leading-snug">
                ...
                <div className="prose prose-sm max-w-none text-[#000] leading-relaxed">
                    ...
                    <p className="mt-4 font-arabic text-right text-lg text-[#1B4D3E]">
