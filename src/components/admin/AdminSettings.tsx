...
import { Plus, Trash2, Edit2, RotateCcw, Save, Tag, Users, Globe, Zap, ClipboardList, Package, Library, Settings, Puzzle, Palette, PlusSquare, Languages, Braces, HelpCircle } from 'lucide-react';
                ...
                <div className="mb-4 pb-4 border-b border-black/5">
                    ...
                    {CATEGORIES.map(cat => (
                        ...
                        >
                            ...
                            <span className="text-[10px] bg-black/5 px-1.5 rounded opacity-50 group-hover:opacity-100">
                ...
                <div className="grid gap-3">
                    {currentItems.length === 0 ? (
                        <div className="text-center py-12 bg-white/50 rounded-2xl border-2 border-dashed border-black/5">
                            <p className="text-black/20 italic">No items found in this category.</p>
                        </div>
                    ) : (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="col-span-1">
                        ...
                        <input className={inp} value={key} onChange={e => setKey(e.target.value)} placeholder="e.g. noun, masculine, I..." />
                    </div>
                </div>
